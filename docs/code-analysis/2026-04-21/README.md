...
- [Cluster 13 — ci-workflow-hygiene](./clusters/13-ci-workflow-hygiene.md) — Run E2E in CI, kill the duplicate Homebrew-tap bump race, decide what to do about the committed generated `assets-embedded.ts`, use `bunx playwright` for Playwright, and delete dead Makefile shell expansions. · **resolved**
